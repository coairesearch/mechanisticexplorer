"""
Real Logit Lens implementation using direct HuggingFace transformers for activation extraction.
"""
...
class LogitLensExtractor:
    """
    Extracts real logit lens predictions from language model layers using direct HuggingFace transformers.
    """
    
    def __init__(self, model_name: str = "openai-community/gpt2"):
        """
        Initialize the extractor with a HuggingFace model.
    ...
    def extract_activations(self, text: str, top_k: int = 5) -> Dict[int, Dict[str, Any]]:
        """
        Extract activations for all tokens in text using real model layers.
        Uses direct HuggingFace transformers approach.
...
class ConversationTokenizer:
    ...
    def __init__(self, tokenizer: GPT2Tokenizer):
        ...
        Args:
            tokenizer: HuggingFace GPT2Tokenizer instance
        """
